...
const sections = [
  {
    ...
    icon: Radio,
    description:
      "A central page for public Skedd channels, streams, feeds and outgoing media links once those destinations are ready.",
    points: ["Video channels", "Stream links", "Public feeds", "Official destinations"],
  },
  {
    title: "Council Streams",
    status: "Planned",
    icon: Tv,
    description:
      "Future Desk Council streams, playful media experiments and public-facing live or recorded content can route through this page.",
    points: ["Council sessions", "Desk streams", "Gameplay feeds", "Event-style media"],
  },
  {
    title: "Archive Links",
    status: "Future",
    icon: Archive,
    description:
      "A clean link area for older media, public records, release clips and project history that should stay findable over time.",
    points: ["Past streams", "Old clips", "Project archives", "Release media"],
  },
];
      ...
      <section className="relative z-10 mx-auto max-w-[1500px] px-4 pb-20 pt-16 md:px-8 md:pt-24">
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-8 text-zinc-300">
            A future hub for Skedd channels, Council streams, public feeds, archives and outgoing media links.
          </p>
        </div>
