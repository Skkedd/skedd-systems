...
const sections = [
  {
    ...
    icon: WandSparkles,
    description:
      "A place for the weird moments where bugs, detours or temporary workarounds accidentally reveal better design truths.",
    points: ["Accidental features", "Useful bugs", "Design pivots", "Unexpected wins"],
  },
  {
    title: "Cursed Build Notes",
    status: "Ongoing",
    icon: Bug,
    description:
      "Some problems are annoying in the moment but funny later. This lane keeps those moments visible as part of the project history.",
    points: ["Broken builds", "Debug chaos", "Fix stories", "Lessons learned"],
  },
  {
    ...
    icon: History,
    description:
      "The background behind core systems, visual ideas, tools, characters and strange little decisions that became part of Skedd.",
    points: ["System origins", "Logo lore", "Desk Council history", "Project milestones"],
  },
];

export default function AppLorePage() {
  return (
      ...
      <section className="relative z-10 mx-auto max-w-[1500px] px-4 pb-20 pt-16 md:px-8 md:pt-24">
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-8 text-zinc-300">
            Weird build history, happy accidents, project lore and the strange moments that shape the systems.
          </p>
        </div>
